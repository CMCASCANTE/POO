from logic.logic import LogicCSV
...
while True:
    ...
    if opcion == "1":
        ...
        id_ciclo = input("Dime el ID del ciclo (ej. C1,C2...): ")
        ...
        id_modulo = input("Dime el ID del módulo (ej. M1,M2...): ")
        ...
        id_alumno = input("Dime el ID del alumno (ej. S1,S2...): ")
